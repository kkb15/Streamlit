...
try:
    ...
    st.error("❌ Required library 'plotly' is not installed.\n\nPlease run `pip install plotly` or add it to your `requirements.txt`.")
    st.stop()
...
- Data to Upload for Analysis → [Sample Dataset](https://drive.google.com/file/d/1h02g6ObGWiTID990u2pWTw5o3aNEYzSb/view?usp=sharing)
        """
    )
...
# ──────────────────────────────────────────────────────────────
elif page == "Understanding the Problem":
...
# ──────────────────────────────────────────────────────────────
elif page == "Conclusion and Insights":
